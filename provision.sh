...
docker run -e "AWS_ACCESS_KEY_ID=$AWS_ACCESS_KEY_ID" -e "AWS_SECRET_ACCESS_KEY=$AWS_SECRET_ACCESS_KEY" -e HOST_HOSTNAME="$(hostname -f)" -v $(pwd):/app centos7-nginx-aws-packer
